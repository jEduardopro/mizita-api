...
use App\Domains\Staff\Infrastructure\Eloquent\Factories\StaffProfileModelFactory;
...
class StaffProfileModel extends Model implements BusinessScopedMediaOwner, HasMedia
{
    ...
    {
        return $this->belongsTo(StaffMemberModel::class, 'staff_member_id');
    }

    protected static function newFactory(): StaffProfileModelFactory
    {
        return StaffProfileModelFactory::new();
    }
}
