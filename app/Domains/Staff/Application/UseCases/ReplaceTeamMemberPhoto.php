...
final class ReplaceTeamMemberPhoto
{
     ...
     */
    public function handle(ReplaceTeamMemberPhotoInput $input): UseCaseResponse
    {
        try {
            $input->validate();
            ...
            $this->photos->replace($businessId, $profile->id, $input->sourcePath, $input->fileName);
