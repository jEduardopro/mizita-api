...
final class InvalidCustomerEmail extends DomainException implements DomainFailure
{
    ...
    {
        return new self('A customer email cannot be empty.');
    }

    public static function malformed(): self
    {
        return new self('The email offered is not a valid email address.');
    }

    public static function tooLong(): self
    {
        return new self('The email offered is longer than a customer email may be.');
    }
