...
type Props = {
     ...
     * It never applies to the dashboard button: a visitor who already has a session
     * is going to the same place whatever the surface called the offer.
     */
    label?: string;
    /**
 ...
 * only pair of destinations it ever offers: register, or log in. A visitor who
 * already has a session is offered the dashboard instead.
 *
