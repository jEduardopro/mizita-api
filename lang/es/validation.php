...
return [
    ...
    |
    | Three more lines belong to this file conceptually but cannot live here:
    | "(and :count more error)", "(and :count more errors)" and "The given
    | data was invalid." - the literal English strings that
    | ValidationException::summarize() passes to the translator to build the
    | `message` field of a 422 body. The sentence *is* the key, and a key with
    | no dot is only ever looked up in the JSON translation file, so they live
    | in lang/es.json. They look like untranslated leftovers there; they are
    | not. Remove or rename them and every Spanish 422 message ends in
    | "(and 1 more error)" in English.
    |
    */
    ...
    'array_keys' => 'El campo :attribute solo puede contener las siguientes claves: :values.',
    ...
    'doesnt_end_with' => 'El campo :attribute no puede terminar por ninguno de los siguientes valores: :values.',
    'doesnt_start_with' => 'El campo :attribute no puede empezar por ninguno de los siguientes valores: :values.',
    ...
    'missing_unless' => 'El campo :attribute no puede estar presente a menos que :other sea :value.',
    'missing_with' => 'El campo :attribute no puede estar presente cuando :values está presente.',
    'missing_with_all' => 'El campo :attribute no puede estar presente cuando :values están presentes.',
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor del campo :attribute ha aparecido en una filtración de datos. Elige otro valor para :attribute.',
    ],
    ...
    */
    ...
    |
    | Every field the application validates today lives here: the Fortify auth
    | forms plus each domain's FormRequest under its Infrastructure/Http/Requests
    | folder. Add the field in both locales whenever a new rule appears.
    |
    */

    'attributes' => [
        // Accounts and the Fortify auth forms.
        ...
        'members.*.name' => 'nombre completo',
        'members.*.email' => 'correo electrónico',
        'members.*.level' => 'nivel de permisos',
        'level' => 'nivel de permisos',
        'job_title' => 'puesto',
        'about' => 'descripción',
        'image' => 'imagen',
        'search' => 'búsqueda',
        ...
        'customer_id' => 'cliente',
        'service_id' => 'servicio',
        'staff_member_id' => 'persona del equipo',
