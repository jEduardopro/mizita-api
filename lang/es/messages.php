...
return [
    ...
    */
    ...
    'errors' => [
        ...
        'payment_transaction_not_voidable' => 'Solo se puede anular un cobro registrado.',
        'void_exceeds_paid_amount' => 'Ese cobro es mayor que el importe que sigue cobrado.',
        ...
        'payment_account_not_found' => 'No hemos encontrado esa cuenta.',
        'invalid_payment_actor' => 'No hemos podido identificar quién registra este pago.',
